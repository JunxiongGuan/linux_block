 ...
 * Note that cntlid of value 0 is considered illegal
 * in the fabrics world. Devices based on earlier
 * NVMe 1.0 specs did not have the subsystem concept;
 * therefore, those devices had their cntlid value set to 0
 * as a result.
 */
#define NVMET_CNTLID_MIN		1
#define NVMET_CNTLID_MAX		0xffef
